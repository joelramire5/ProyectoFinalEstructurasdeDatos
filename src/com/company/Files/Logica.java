...
public class Logica {
    ...
    //Se debe recorrer toda la cola, sin modificarla, aumentando el tiempo en cola +1
    ...
    public void obtenerTiempoPromedioTramites(){
        ...
        System.out.println("Promedio de tramites: " + contadorTiempos/listaPersonas.size());
    }
